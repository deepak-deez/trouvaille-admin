...
const Menu = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className={` absolute top-0 bg-white rounded-lg w-[45%] p-3 flex shadow-[5px_10px_25px_rgba(102,101,130,0.15)] flex-col justify-center items-start ${!menu && "hidden"}`}>
