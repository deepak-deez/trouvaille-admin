...
import browserIcon from "../../assets/image/trip/browse-icon.svg";

const AddNewTrip = ({ tripPop, setTripPop }) => {
    ...
    >
      <div className="flex flex-col justify-center m-auto xl:w-[30%] md:w-[40%] w-[80%] bg-white p-4 ">
        <div className="flex justify-between py-2">
          <h2 className="text-start font-bold py-4">Add Trip Categories</h2>
          <button
            className=""
            onClick={() => {
              setTripPop(!tripPop);
